...
newTable.innerHTML = "<thead><th>Roll No.</th><th>Name</th><th>Exam Name</th><th>Marks</th></thead>";
for(var student of students_1)
{
    if(student.Subject1==teacher.subjects||student.Subject2==teacher.subjects||student.Subject3==teacher.subjects)
    {
    ...
    tdexamname.textContent = "Quiz 1";
    if(student.Subject1==teacher.subjects)
    tdmarks.textContent = student.Sub1Marks
    else if(student.Subject2==teacher.subjects)
    tdmarks.textContent = student.Sub2Marks
    else if(student.Subject3==teacher.subjects)
    tdmarks.textContent = student.Sub3Marks
    newRow.appendChild(tdrollno);
    newRow.appendChild(tdname);
    newRow.appendChild(tdexamname);
    newRow.appendChild(tdmarks);
